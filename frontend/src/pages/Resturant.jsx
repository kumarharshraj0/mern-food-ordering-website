            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="relative w-full max-w-lg flex-1">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-xl border border-orange-300 focus:border-orange-600 focus:ring-1 focus:ring-orange-600 outline-none bg-white transition-all shadow-sm"
                />
              ...
              <button
                ...
                className="lg:hidden flex items-center gap-2 px-6 py-2 bg-white border border-orange-200 rounded-xl text-orange-600 font-bold hover:bg-orange-50 transition-all shadow-sm group"
              >
                <SlidersHorizontal className="w-4 h-4 group-hover:rotate-180 transition-transform duration-500" />
                <span>Filters</span>
                {(selectedCuisines.length > 0 || selectedCities.length > 0) && (
                  <span className="flex items-center justify-center w-5 h-5 bg-orange-600 text-white text-[10px] rounded-full">
                    {selectedCuisines.length + selectedCities.length}
                  </span>
                )}
              </button>
            </div>
